...
<div class="bg_header_second">
    <div class="page_con">
        ...
        <ul class="navS">
            <li><a href="pages/04_railway_booking/booking_no_quote.jsp">铁路订舱</a></li>
            <li><a href="pages/05_railway_class/railway_class.jsp">铁路班列</a></li>
            <li><a href="pages/06_order_tracking/order_tracking.jsp">订舱跟踪</a></li>
            <li><a href="pages/07_about_us/about.jsp">关于平台</a></li>
        </ul>
        <ul class="func_top">
...
<div class="bg_banner_help">
    <div class="page_con">
        <h2 class="QA"></h2>
        <div class="bg_w_search fL margin_se_qa"><a class="se" href="#"></a>
            <input type="text" value="" placeholder="您有什么需要帮忙的"/>
        </div>
    </div>
</div>
<div class="wrap_h_d pTop_60">
    <ul class="ul_qa">
        <li><i class="q"></i>国外段可以送货吗？</li>
        <li><i class="a"></i>可以的。您提供门点地址，我们系统目前就可以自动报价</li>
    </ul>
    <div class="bg_FAQ clear">
        <h3>常见问题</h3>
        <table>
            <colgroup>
                <col width="342px">
            ...
            <tr>
                <td><a href="#"><i></i>国内可以安排退货吗？</a></td>
                <td><a href="#"><i></i>国外段可以送货吗？</a></td>
                <td><a href="#"><i></i>铁路运输的速度怎么样的速度怎么样？</a></td>
            </tr>
            <tr>
                <td><a href="#"><i></i>铁路中的运单是提货凭证？</a></td>
                <td><a href="#"><i></i>铁路中的运单是提货凭证？</a></td>
                <td><a href="#"><i></i>我有货物要送亚马逊仓库，有什么要求吗？</a></td>
            </tr>
            <tr>
                <td><a href="#"><i></i>海关对货物的查验有哪些要求？</a></td>
                <td><a href="#"><i></i>当货物查验时需要提供哪些材料？</a></td>
                <td></td>
            </tr>
        </table>
    </div>
...
<div class="wrap_login" id="dialog1">
    ...
    <div class="wrap_register"> <a href="javascript:;" title="关闭" class="closeL">×</a>
        <div class="info_reg">
            ...
            <p>只需几步即可创建您的个人帐户<br/>
                并直接使用我们的在线服务。</p>
            <a class="btn_reg" href="../01_register/register_1.jsp">注册</a> </div>
    </div>
</div>
