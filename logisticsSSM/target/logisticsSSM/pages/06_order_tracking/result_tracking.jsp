...
<div class="bg_header">
    <div class="page_con">
        ...
        <ul class="nav">
            ...
            <li><a class="current" href="../06_order_tracking/order_tracking.jsp">订舱跟踪</a></li>
...
<div class="bg_tracking">
    <div class="page_con">
        <div class="wrap_s_track">
            <h2>订航跟踪</h2>
            <div class="track_inp_btn">
                <input type="text" placeholder="请输入您要查询的订单号"/>
                <a href="#">跟踪</a> </div>
        </div>
        <div class="bg_com pTB_40 mTop_20 clear">
            <h2 class="title_main">跟踪结果</h2>
            <div class="w_result_track width_600">
                <table class="table_t">
                    <colgroup>
                        <col width="140px;">
                        <col>
                    ...
                    <tr>
                        <th colspan="2"><span>实物入库情况仅限部分CFS仓库</span></th>
                    ...
                    <tr>
                        <th>喷头：</th>
                        <td>KT.C PNC. 1-1 MADE IN THAILAND INV.NO.17/1281 TO YOKOHAMA</td>
                    </tr>
                    <tr>
                        <th>备注：</th>
                        <td>FT4/10 REMARK(1PP)SICHAFED&S/CRUSHEO</td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <img src="../../images/img_t_1.png" alt=""/>
                            <img src="../../images/img_t_2.png" alt=""/>
                        </td>
